...
#ifndef PGMACLAYER_H_
#define PGMACLAYER_H_
...
class MIXIM_API PgMacLayer: public BaseMacLayer
{
public:
...
protected:
	...
	enum t_mac_timer
	{
		TIMER_NULL = 0, TIMER_BACKOFF, TIMER_CCA, TIMER_SIFS, TIMER_RX_ACK,
	};
